...
function ReportScreen({match, history}) {
    ...
    return (
        ...
        <Container className="fluid">
            <p>{`https://datastudio.google.com/embed/reporting/${match.params.id}/page/2SX2C/?params=%7B%22df3%22:%22include%25EE%2580%25800%25EE%2580%2580IN%25EE%2580%2580${manv.text}%22%7D`}</p>
            <Link to="/" className="btn btn-primary my-1">
				Go Back
			</Link>
        <Card style={{backgroundColor : "#f0ebf8", border: 0}}>
            <div align="center">
            <iframe width="600" className="vh-100" src={`https://datastudio.google.com/embed/reporting/${match.params.id}/page/2SX2C/?params=%7B%22df3%22:%22include%25EE%2580%25800%25EE%2580%2580IN%25EE%2580%2580${manv.text}%22%7D`}  style={{ border: 1 }} allowFullScreen></iframe>
            </div>
        </Card>
        </Container>
    )
